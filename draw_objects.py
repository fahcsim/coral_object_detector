...
import logging
def draw_objects_coral(objs, shinobi_image, label, add_labels): # fix this up so that we're passing in a set of coordinates instead of obj
...
def draw_objects_deepstack(response, shinobi_image, label_index, add_labels):
